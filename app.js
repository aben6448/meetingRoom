...
function renderRoomCard(booking) {
    ...
    return `
        <div class="room-card room-${booking.room}" onclick='showDetail(${bookingStr})'>
...
function showDetail(booking) {
    ...
    modalBody.innerHTML = `
        ...
        <div class="modal-actions">
            <button class="btn btn-primary" onclick='editBooking(${bookingStr})'>编辑</button>
...
function showQuickBookModal(presetDate = null, presetPeriod = null) {
    ...
    modalBody.innerHTML = `
        <form id="quickBookForm" class="booking-form">
            ...
            <div class="form-group">
                <label class="form-label">部门</label>
                <input type="text" id="quick_department" class="form-input" placeholder="请输入部门" required>
            </div>
            
            <div class="form-group">
                <label class="form-label">预订人</label>
                <input type="text" id="quick_booker" class="form-input" placeholder="请输入姓名" required>
            </div>
            
            <div class="form-group">
                <label class="form-label">联系方式</label>
                <input type="tel" id="quick_contact" class="form-input" placeholder="请输入联系方式" required>
            </div>
